...
MODEL_PATH = MODELS_DIR / "network_attack_classifier.pkl"
FEATURES_PATH = MODELS_DIR / "network_classifier_features.pkl"
...
def main():
    ...
    print("Network classifier processed shape:", X.shape)
